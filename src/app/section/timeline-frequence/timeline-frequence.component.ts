...
export class TimelineFrequenceComponent {
  ...
  private chartdivFreq: am4charts.XYChart = undefined;
  ...
  private deleteCharts(): void {
    if (this.chartdivFreq !== undefined) {
      this.zone.runOutsideAngular(() => {
        this.chartdivFreq.dispose();
      });
      this.chartdivFreq = undefined;
    }
  }

  private majListeEtatLogonConnexion(): [] {
    ...
    let liste;
    /**  let element :{name:string, icon: string, text: string};
     element.name="coucou";
     element.icon = dance;
     element.text = "ma_freq";
     liste.add(element);*/
    return liste;
  }
  ...
  private timelinesUpdate(): void {
    ...
    this.zone.runOutsideAngular(() => {
      ...
      //TODO :  changer les icones à afficher
      ...
      let chart = am4core.create("chartdivFreq", am4plugins_timeline.CurveChart);
      ...
      // dateAxis.renderer.points = [{ x: -1000, y: 0 }, { x: 0, y: 0 }];
